...
const VisualHierarchy: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Visual Hierarchy Definition | The Dynamic Rankers</title>
        <meta
          name="description"
          content="Visual hierarchy uses size, spacing, contrast, and placement to direct user focus. Done well, it helps people scan quickly and take confident action."
        />
      </Helmet>
