...
const InternalDashboard = () => {
  ...
  return (
    <div className="h-screen bg-[#06080D] flex overflow-hidden font-sans">
      {/* Sidebar Nav */}
      <div className="w-80 flex flex-col border-r border-zinc-800/50 bg-[#111111]">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar pt-6">
          ...
          <div className="px-6 mb-8 space-y-1">
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all group ${activeView === 'tasks' ? 'bg-[#353739] text-white border border-zinc-700/50 shadow-sm' : 'hover:bg-[#353739]/30 text-zinc-400'}`}
            >
            ...
            <button
              onClick={() => { setActiveView('customers'); setSelectedCustomer(null); }}
          ...
          {activeView === 'tasks' && (
            <div className="px-6 mb-8 border-t border-zinc-800/50 pt-8">
