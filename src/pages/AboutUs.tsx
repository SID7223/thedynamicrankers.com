    ...
    <>
      ...
      <header className="bg-white shadow-md dark:bg-gray-800">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          >
            <a href="#" className="text-gray-700 hover:text-blue-600 transition dark:text-gray-300 dark:hover:text-blue-400">Digital Marketing</a>
            <a href="#" className="text-gray-700 hover:text-blue-600 transition dark:text-gray-300 dark:hover:text-blue-400">AI Solutions</a>
            <a href="#" className="text-gray-700 hover:text-blue-600 transition dark:text-gray-300 dark:hover:text-blue-400">Create Your Website</a>
            <a href="#" className="text-gray-700 hover:text-blue-600 transition dark:text-gray-300 dark:hover:text-blue-400">Content Creation</a>
          </motion.nav>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                    We are a dedicated team of professionals who are passionate about what they do. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  </p>
                </motion.div>
              </div>
              ...
              <motion.div 
                ...
                className="mb-12"
              >
                <img src="https://via.placeholder.com/1200x600" alt="About Us" className="rounded-lg shadow-lg w-full" />
              </motion.div>
            </div>
          </div>
        </main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              >
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">Website Development</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">SEO Services</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">Search Engine Marketing</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">Social Media Marketing</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">Customer Support</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">Our Services</a></li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">Portfolio</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">Blog</a></li>
                  <li><a href="#" className="text-gray-300 hover:text-blue-400 transition">Career</a></li>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <p className="text-gray-300">eric@thedynamicrankers.com</p>
                </div>
                <div>
                  <p className="font-medium">Phone:</p>
                  <p className="text-gray-300">+1 (346) 556-1173</p>
                </div>
                <div>
                  <p className="font-medium">Address:</p>
                  <p className="text-gray-300">234 Westheimer Rd, Apt 101, Houston, TX 77077</p>
                </div>
              </div>
            </motion.div>
          </div>
