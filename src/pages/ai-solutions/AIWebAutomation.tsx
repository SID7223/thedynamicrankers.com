          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <strong className="text-gray-900 dark:text-white"><strong>Intelligent <Link to="/definitions/workflow-automation" className="text-blue-600 hover:text-blue-800 underline">Workflow Automation</Link>:</strong> 
