...
const TestimonialsLanding = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50 dark:bg-[#06080D] dark:from-transparent dark:to-transparent transition-colors duration-300">
