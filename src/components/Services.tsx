      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {services.map((service, index) => (
            <div key={index} className="bg-gray-50 sm:bg-white dark:bg-gray-700 rounded-xl shadow-md sm:shadow-lg hover:shadow-2xl transition-all duration-300 p-4 sm:p-8 group hover:transform hover:scale-105 border border-gray-200 sm:border-transparent dark:border-transparent">
