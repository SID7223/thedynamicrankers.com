    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 sm:pt-0">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto min-h-screen sm:min-h-0 flex flex-col items-center justify-center sm:justify-start sm:pt-20">
          ...
          <p className="text-base sm:text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed px-2">
      ...
      <div className="sm:hidden relative z-10 pb-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto">
            <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-6 hover:bg-opacity-20 transition-all duration-300 aspect-square flex flex-col items-center justify-center">
              <h3 className="text-3xl font-bold text-white mb-2">50+</h3>
              <p className="text-blue-100 text-sm text-center leading-tight">Projects Completed</p>
            </div>
            <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-6 hover:bg-opacity-20 transition-all duration-300 aspect-square flex flex-col items-center justify-center">
              <h3 className="text-3xl font-bold text-white mb-2">24/7</h3>
              <p className="text-blue-100 text-sm text-center leading-tight">Customer Support</p>
            </div>
            <div className="col-span-2 bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-6 hover:bg-opacity-20 transition-all duration-300 aspect-[2/1] flex flex-col items-center justify-center">
              <h3 className="text-3xl font-bold text-white mb-2">100%</h3>
              <p className="text-blue-100 text-sm text-center leading-tight">Client Satisfaction</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          <div className="mt-16 grid grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-4 sm:p-8 hover:bg-opacity-20 transition-all duration-300">
              ...
              <p className="text-blue-100 text-lg">Customer Support</p>
            </div>
            <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-lg p-4 sm:p-8 hover:bg-opacity-20 transition-all duration-300">
              <h3 className="text-4xl font-bold text-white mb-3">100%</h3>
