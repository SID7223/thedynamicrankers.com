      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <div className="flex flex-col items-center justify-center min-h-screen pt-20 sm:pt-0">
            ...
            </h1>           <p className="text-lg sm:text-xl md:text-2xl text-[#0a0d36] dark:text-white mb-8 leading-relaxed px-4 glare-text [--glare-color:#0a0d36] dark:[--glare-color:white]">
