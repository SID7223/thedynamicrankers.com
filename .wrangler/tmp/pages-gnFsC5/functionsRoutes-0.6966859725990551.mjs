...
import { onRequestGet as __api_internal_debug_schema_ts_onRequestGet } from "/app/functions/api/internal/debug_schema.ts"
import { onRequestPost as __api_internal_logout_ts_onRequestPost } from "/app/functions/api/internal/logout.ts"
import { onRequestPost as __api_internal_read_receipts_ts_onRequestPost } from "/app/functions/api/internal/read_receipts.ts"
...
import { onRequest as __api_internal_analytics_ts_onRequest } from "/app/functions/api/internal/analytics.ts"
...
import { onRequest as __api_internal_message_history_ts_onRequest } from "/app/functions/api/internal/message_history.ts"
import { onRequest as __api_internal_presence_ts_onRequest } from "/app/functions/api/internal/presence.ts"
import { onRequest as __api_internal_reactions_ts_onRequest } from "/app/functions/api/internal/reactions.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_internal_debug_schema_ts_onRequestGet],
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_internal_logout_ts_onRequestPost],
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_internal_read_receipts_ts_onRequestPost],
    },
  {
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_internal_analytics_ts_onRequest],
    },
  {
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_internal_message_history_ts_onRequest],
    },
  {
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_internal_reactions_ts_onRequest],
    },
  {
