...
// .wrangler/tmp/bundle-eh95TK/checked-fetch.js
...
// .wrangler/tmp/pages-gnFsC5/functionsWorker-0.9385919176303297.mjs
  ...
  try {
    const stream = new ReadableStream({
      async start(controller) {
        ...
        const sendEvent = /* @__PURE__ */ __name2((event) => {
          try {
...
var jsonResponse2 = /* @__PURE__ */ __name2((data, status = 200) => {
...
var jsonResponse3 = /* @__PURE__ */ __name2((data, status = 200) => new Response(JSON.stringify(data), {
  status,
  headers: { "Content-Type": "application/json" }
}), "jsonResponse");
...
var jsonResponse4 = /* @__PURE__ */ __name2((data, status = 200) => new Response(JSON.stringify(data), {
  status,
  headers: { "Content-Type": "application/json" }
}), "jsonResponse");
...
__name2(ContactEmailTemplate, "ContactEmailTemplate");
...
__name2(OnboardingEmailTemplate, "OnboardingEmailTemplate");
...
// .wrangler/tmp/bundle-eh95TK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-eh95TK/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9385919176303297.js.map
